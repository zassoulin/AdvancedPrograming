...
public class MainTrain {
	...
	public static void testDictionary() {
		...
		if(!d.challenge("lazy"))
			System.out.println("problem with dictionarry in challenge (-5)");
...
//"BloomFilter.java""ParIOSearcher.java""CacheManager.java""LFU.java""IOSearcher.java""Dictionary.java""LRU.java"
